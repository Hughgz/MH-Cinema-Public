            ...
            <div className="grid md:grid-cols-2 grid-cols-1 md:gap-4 gap-1">
                ...
                <div className="col-span-1">
                    ...
                    <div className="w-full my-1 relative h-auto border inline-flex items-center min-w-0 text-[14px] bg-[#ECECEC] rounded-md transition-all duration-300 opacity-70 cursor-not-allowed">
                        ...
                        <input disabled type="text" className="bg-transparent w-full h-9 px-8 focus:ring-2 focus:outline-blue-500 focus:rounded-md grayscale opacity-70 cursor-not-allowed" value={`${currentBirthday[0]} - ${String(currentBirthday[1]).padStart(2, '0')} - ${String(currentBirthday[2]).padStart(2, '0')}`} />
                ...
                <div className="col-span-1">
                    ...
                    <div className="gender__wrapper flex flex-wrap justify-start items-center md:mt-8">
                        <div className="flex items-center mr-4 grayscale opacity-70 cursor-not-allowed">
                            <input disabled type="radio" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 grayscale opacity-70 cursor-not-allowed pointer-events-none" value="Male" checked={account.sex === 'Male' ? true : false} />
                        ...
                        <div className="flex items-center grayscale opacity-70 cursor-not-allowed">
                            <input disabled type="radio" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 grayscale opacity-70 cursor-not-allowed pointer-events-none" value="Female" checked={account.sex === 'Female' ? true : false} />
