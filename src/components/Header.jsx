...
import { isLogIn, logout } from '../redux/actions/authAction';
...
const Header = () => {
    ...
    useEffect(() => {
        // Check if the token and account exist in localStorage and Redux state
                            ...
                            <div className="hidden screen1200:flex screen1200:grow screen1200:basis-6/12 screen1200:justify-end uppercase items-center relative  transition-all duration-300">
                                ...
                                <div className="md:px-2 py-4 relative items-center text-left md:cursor-pointer group transition-all duration-500 ease-in-out md:flex hidden">
                                    <div className='w-[40px] h-[40px] leading-[62px] text-center rounded-full bg-[#D0D0D0] border-4 border-solid border-[#E9E9E2] flex-none  mr-4'>
                                        <img src={account.image} className='w-full h-full rounded-full object-cover duration-500 ease-in-out group-hover:opacity-100 scale-100 blur-0 grayscale-0)' />
                                    </div>
                                    <div className="flex items-center justify-center gap-[6px]">
                                        ...
                                        <p className="flex-auto md:flex hidden flex-col text-sm font-bold not-italic justify-start items-start md:pr-0 group hover:text-orange-500 transition-all duration-500 ease-in-out capitalize">{account.fullName}
                                            <span className="block text-xs font-light not-italic">Khách hàng</span>
                                        </p>
                                    </div>
                                    <button type="button" className="md:py-7 md:hidden flex text-sm font-bold not-italic justify-between items-center md:pr-0 group hover:text-orange-500 transition-all duration-500 ease-in-out">{account.fullName}</button>
                                ...
                                <div className="hover">
                                    <div className="px-3 py-7 text-left md:cursor-pointer group  transition-all duration-300 flex">
                                        <a href="/" className="cursor-pointer logo__header grow-0">
                                            <img alt="MH Cinema" loading="lazy" width="40" height="38" decoding="async" data-nimg="1" src={mem_register} />
                                        </a>
                                            ...
                                            <div className="bg-white min-w-[425px] max-w-[780px] border border-white border-solid rounded px-6 py-4" >
                                                <div className="grid grid-cols-2 gap-5">
                                                    ...
                                                    <div className="flex flex-col justify-start items-center gap-4 pt-6">
                                                        ...
                                                        <h3 className="text-sm font-bold not-italic capitalize text-center">Đăng Ký Thành Viên MH Nhận Ngay Ưu Đãi!</h3>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
